...
function Asection4() {
  ...
  return (
    <>
    {section8data.map((section8data1 ,mnlott22) =>(
    <section className="asection4" key={mnlott22}>
...
<div className="section8unun1box">
     <h2 className='widenditm'>{section8data1.text1}</h2>
                        <p className='widenditm'>{section8data1.text2}</p> 
